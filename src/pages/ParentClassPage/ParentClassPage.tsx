            ...
            <div className={"prod p2"} id={"p2"}>
              ...
              <div className={"pbd2"}>
                <div className={"priceask"}>
                  {data.texts.t030}
                  <small className={"muted"} style={{ display: "block", fontWeight: "400", fontSize: "13px", marginTop: "4px" }}>
                    {data.texts.t031}
                  </small>
                </div>
                <div className={"forwho"}>
          ...
          <div className={"ladder"}>
            <div className={"lrow"}>
              ...
              <div>
                ...
                <p>
                  {data.texts.t057}
                  <a href={data.links.link005} style={{ color: "var(--o-d)", fontWeight: "600" }}>
                    {data.texts.t058}
                  </a>
                  {data.texts.t059}
                </p>
            ...
            <div className={"lrow"}>
              ...
              <div>
                ...
                <p>
                  <a href={data.links.link006} style={{ color: "var(--o-d)", fontWeight: "600" }}>
                    {data.texts.t062}
                  </a>
                  {data.texts.t063}
                </p>
            ...
            <div className={"lrow"}>
              ...
              <div>
                ...
                <p>
                  <a href={data.links.link007} style={{ color: "var(--o-d)", fontWeight: "600" }}>
                    {data.texts.t066}
                  </a>
                  {data.texts.t067}
                </p>
          ...
          <div className={"books"}>
            <div className={"book"}>
              ...
              <div className={"bd"}>
                ...
                <a className={"btn p"} href={data.links.link008} target="_blank" rel="noreferrer">
                  {data.texts.t074}
                </a>
              </div>
            </div>
            <div className={"book"}>
              ...
              <div className={"bd"}>
                ...
                <a className={"btn p"} href={data.links.link009} target="_blank" rel="noreferrer">
                  {data.texts.t079}
                </a>
              </div>
            </div>
      ...
      <section className={"tight"}>
        <div className={"wrap"}>
          <div className={"band"}>
            ...
            <div className={"btns"}>
              <a className={"btn g"} href={data.links.link012} target="_blank" rel="noreferrer">
                {data.texts.t107}
              </a>
