            ...
            <div>
              ...
              <div className={"tpanel"} style={{ marginTop: "13px" }}>
                ...
                <div className={"b"}>
                  ...
                  <a className={"btn s"} href={data.links.link009} style={{ marginTop: "10px", width: "100%", justifyContent: "center", fontSize: "13.5px" }}>
                    {data.texts.t064}
                  </a>
                </div>
              </div>
        ...
        <div className={"wrap"}>
          ...
          <div className={"tier-block"} data-tier={"ancs"} id={"ancs"}>
            <div className={"tier-head"}>
              <div className={"tier-badge"} style={{ background: "var(--c-ancs)" }}>
                {data.texts.t110}
              </div>
              <h2 style={{ color: "var(--c-ancs)" }}>
                {data.texts.t111}
              </h2>
              <span>
                {data.texts.t112}
              ...
              <div className={"course"} id={"ancs-1"}>
                ...
                <div style={{ minWidth: "0" }}>
                  ...
                  <div className={"cmeta"}>
                    ...
                    <a className={"meta-cta"} href={data.links.link018} target="_blank" rel="noreferrer">
                      {data.texts.t137}
                    </a>
                  </div>
                </div>
              ...
              <div className={"course"} id={"ancs-2"}>
                ...
                <div style={{ minWidth: "0" }}>
                  ...
                  <div className={"cmeta"}>
                    ...
                    <a className={"meta-cta"} href={data.links.link019} target="_blank" rel="noreferrer">
                      {data.texts.t158}
                    </a>
                  </div>
                </div>
              ...
              <div className={"course"} id={"ancs-3"}>
                ...
                <div style={{ minWidth: "0" }}>
                  ...
                  <div className={"cmeta"}>
                    ...
                    <a className={"meta-cta"} href={data.links.link020} target="_blank" rel="noreferrer">
                      {data.texts.t179}
                    </a>
                  </div>
                </div>
          ...
          <div className={"tier-block"} data-tier={"choi"} id={"choi"}>
            <div className={"tier-head"}>
              <div className={"tier-badge"} style={{ background: "var(--c-choi)" }}>
                {data.texts.t180}
              </div>
              <h2 style={{ color: "var(--c-choi)" }}>
                {data.texts.t181}
              </h2>
              <span>
                {data.texts.t182}
              ...
              <div className={"course"} id={"choi-1"}>
                ...
                <div style={{ minWidth: "0" }}>
                  ...
                  <div className={"cmeta"}>
                    ...
                    <a className={"meta-cta"} href={data.links.link021} target="_blank" rel="noreferrer">
                      {data.texts.t203}
                    </a>
                  </div>
                </div>
              ...
              <div className={"course"} id={"choi-2"}>
                ...
                <div style={{ minWidth: "0" }}>
                  ...
                  <div className={"cmeta"}>
                    ...
                    <a className={"meta-cta"} href={data.links.link022} target="_blank" rel="noreferrer">
                      {data.texts.t222}
                    </a>
                  </div>
                </div>
              ...
              <div className={"course"} id={"choi-3"}>
                ...
                <div style={{ minWidth: "0" }}>
                  ...
                  <div className={"cmeta"}>
                    ...
                    <a className={"meta-cta"} href={data.links.link023} target="_blank" rel="noreferrer">
                      {data.texts.t242}
                    </a>
                  </div>
                </div>
          ...
          <div className={"tier-block"} data-tier={"mxlh"} id={"mxlh"}>
            <div className={"tier-head"}>
              <div className={"tier-badge"} style={{ background: "var(--c-mxlh)" }}>
                {data.texts.t243}
              </div>
              <h2 style={{ color: "var(--c-mxlh)" }}>
                {data.texts.t244}
              </h2>
              <span>
                {data.texts.t245}
              ...
              <div className={"course"} id={"mxlh-1"}>
                ...
                <div style={{ minWidth: "0" }}>
                  ...
                  <div className={"cmeta"}>
                    ...
                    <a className={"meta-cta"} href={data.links.link024} target="_blank" rel="noreferrer">
                      {data.texts.t268}
                    </a>
                  </div>
                </div>
              ...
              <div className={"course"} id={"mxlh-2"}>
                ...
                <div style={{ minWidth: "0" }}>
                  ...
                  <div className={"cmeta"}>
                    ...
                    <a className={"meta-cta"} href={data.links.link025} target="_blank" rel="noreferrer">
                      {data.texts.t287}
                    </a>
                  </div>
                </div>
              ...
              <div className={"course"} id={"mxlh-3"}>
                ...
                <div style={{ minWidth: "0" }}>
                  ...
                  <div className={"cmeta"}>
                    ...
                    <a className={"meta-cta"} href={data.links.link026} target="_blank" rel="noreferrer">
                      {data.texts.t305}
                    </a>
                  </div>
                </div>
              ...
              <div className={"course"} id={"mxlh-4"}>
                ...
                <div style={{ minWidth: "0" }}>
                  ...
                  <div className={"cmeta"}>
                    ...
                    <a className={"meta-cta"} href={data.links.link027} target="_blank" rel="noreferrer">
                      {data.texts.t328}
                    </a>
                  </div>
                </div>
      ...
      <section id={"dinh"}>
        <div className={"wrap"}>
          <div className={"tier-head"} style={{ borderColor: "#C9A75F" }}>
            <div className={"tier-badge"} style={{ background: "var(--ink)", color: "#C9A75F" }}>
              {data.texts.t329}
            </div>
            <h2>
              {data.texts.t330}
          ...
          <div className={"btns"} style={{ marginTop: "22px" }}>
            <a className={"btn p"} href={data.links.link028} target="_blank" rel="noreferrer">
              {data.texts.t357}
            </a>
          </div>
        </div>
          ...
          <div className={"steps"}>
            ...
            <div className={"step"}>
              ...
              <div>
                ...
                <p>
                  {data.texts.t382}
                  <a href={data.links.link029} style={{ color: "var(--o-d)", fontWeight: "600" }}>
                    {data.texts.t383}
                  </a>
                </p>
              </div>
      ...
      <section className={"tight"}>
        <div className={"wrap"}>
          <div className={"band"}>
            ...
            <div className={"btns"}>
              <a className={"btn g"} href={data.links.link030} target="_blank" rel="noreferrer">
                {data.texts.t386}
              </a>
              <a className={"btn s"} href={data.links.link031} target="_blank" rel="noreferrer">
                {data.texts.t387}
              </a>
            </div>
          </div>
