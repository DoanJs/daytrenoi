...
export const homePageMockData: HomePageData = {
  "texts": {
    ...
    "t042": "Lộ trình đào tạo bắt đầu từ dưới lên, bạn hãy bấm vào từng bậc để xem nội dung. Tháp này được xây dựng để bạn phát triển chuyên môn Ngôn ngữ trị liệu bài bản và chuyên nghiệp.",
    ...
    "t086": "ÂNTL Bậc 1 — Âm ngữ trị liệu bệ phóng (A1)",
